...
function mostrarPersonajes(array) {
    ...
    array.forEach((personaje) => {
        ...
        /*
                ...
                divPersonajes.appendChild(check);
        
                check.innerHTML = 'Marcar para guardar'
                check.type = 'checkbox';
                check.value = per.id;
                img.src = per.path;
        
                div.innerHTML = per.name + '<br>' + per.modified + '<br>' + per.comics;*/
    });
}
...
function mostrarPersonajesBD(array) {
    ...
    array.forEach(personaje => {
        ...
        div.innerHTML = personaje.name + '<br>' + personaje.modified;*/
    });
}
